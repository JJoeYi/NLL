...
package com.orbitalnll.nll.posedetector.classification;

import static com.orbitalnll.nll.posedetector.classification.PoseEmbedding.getPoseEmbedding;
import static com.orbitalnll.nll.posedetector.classification.Utils.maxAbs;
import static com.orbitalnll.nll.posedetector.classification.Utils.multiply;
import static com.orbitalnll.nll.posedetector.classification.Utils.multiplyAll;
import static com.orbitalnll.nll.posedetector.classification.Utils.subtract;
import static com.orbitalnll.nll.posedetector.classification.Utils.sumAbs;
...
public class PoseClassifier {
  ...
  // sub constructor if you want to just pass poseSamples and use set constants
  ...
  // Adds landmarks of given pose into a List
  ...
  // MAIN method, returns basically a map (class name -> confidence float)
